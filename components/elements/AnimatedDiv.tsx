    ...
    return (
      <div>
        ...
        {faqs.map((faq: any, index: any) => (
                ...
                <AccordionItem key={index} ref={faqRefs[index]} className="faq-item w-full  border-2 border-dashed border-slate-500 dark:border-slate-600 rounded-sm mb-5  "  value={"item-"+index}>
